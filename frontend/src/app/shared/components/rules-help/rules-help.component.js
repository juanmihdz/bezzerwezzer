...
function RulesHelpComponent_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(38, "En cada ronda todos responden la categor\u00EDa del mismo valor: primero 1 punto, despu\u00E9s 2, 3 y 4. Antes de cada pregunta hay 10 segundos t\u00E1cticos; solo se omiten si todos votan \u00ABListo\u00BB.");
    i0.ɵɵdomElementEnd()()();
