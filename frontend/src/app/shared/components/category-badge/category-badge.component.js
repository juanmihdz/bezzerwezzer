...
function CategoryBadgeComponent_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵstyleProp("border-color", ctx_r0.color + "40");
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction2(16, _c0, ctx_r0.sizeClasses[ctx_r0.size], ctx_r0.isHighlighted ? "shadow-2xl z-10 ring-1 ring-white/25" : "hover:scale-[1.02]"));
    i0.ɵɵadvance();
    i0.ɵɵstyleProp("background-color", ctx_r0.color);
    i0.ɵɵadvance();
