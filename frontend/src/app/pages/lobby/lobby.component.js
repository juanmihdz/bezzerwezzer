...
function LobbyComponent_For_30_Conditional_6_Template(rf, ctx) { if (rf & 1) {
...
function LobbyComponent_For_30_Conditional_10_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵnamespaceSVG();
...
function LobbyComponent_For_30_Conditional_10_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelementStart(0, "svg", 26);
...
function LobbyComponent_For_30_Conditional_10_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 28);
    i0.ɵɵlistener("click", function LobbyComponent_For_30_Conditional_10_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const player_r2 = i0.ɵɵnextContext().$implicit; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.setReady(!player_r2.ready)); });
    i0.ɵɵconditionalCreate(1, LobbyComponent_For_30_Conditional_10_Conditional_1_Template, 4, 0)(2, LobbyComponent_For_30_Conditional_10_Conditional_2_Template, 4, 0);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const player_r2 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵclassProp("ready-button--active", player_r2.ready);
    i0.ɵɵattribute("aria-pressed", player_r2.ready)("aria-label", player_r2.ready ? "Marcar como no listo" : "Marcar como listo");
    i0.ɵɵadvance();
    i0.ɵɵconditional(player_r2.ready ? 1 : 2);
} }
function LobbyComponent_For_30_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "article", 19);
    i0.ɵɵelement(1, "app-player-avatar", 20);
    i0.ɵɵelementStart(2, "div", 21)(3, "div", 22)(4, "h2");
    i0.ɵɵtext(5);
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(6, LobbyComponent_For_30_Conditional_6_Template, 4, 0, "span", 23);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(7, "div", 24);
    i0.ɵɵelement(8, "span");
    i0.ɵɵtext(9);
    i0.ɵɵelementEnd()();
    i0.ɵɵconditionalCreate(10, LobbyComponent_For_30_Conditional_10_Template, 3, 5, "button", 25);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const player_r2 = ctx.$implicit;
    const ɵ$index_52_r4 = ctx.$index;
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵstyleProp("animation-delay", ɵ$index_52_r4 * 80 + "ms");
    i0.ɵɵclassProp("player-card--ready", player_r2.ready);
    i0.ɵɵadvance();
    i0.ɵɵproperty("username", player_r2.username)("color", player_r2.color)("showName", false)("showCrown", false)("isActive", player_r2.ready);
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(player_r2.username);
    i0.ɵɵadvance();
    i0.ɵɵconditional(player_r2.playerId === ctx_r2.hostId() ? 6 : -1);
    i0.ɵɵadvance();
    i0.ɵɵclassProp("player-status--ready", player_r2.ready);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", player_r2.ready ? "Listo para jugar" : "Prepar\u00E1ndose", " ");
    i0.ɵɵadvance();
    i0.ɵɵconditional(player_r2.playerId === ctx_r2.myId() ? 10 : -1);
} }
function LobbyComponent_For_32_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "article", 15)(1, "div", 31);
    i0.ɵɵtext(2, "?");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "div", 21)(4, "h2");
...
function LobbyComponent_Conditional_34_Conditional_1_Template(rf, ctx) { if (rf & 1) {
...
function LobbyComponent_Conditional_34_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LobbyComponent_Conditional_34_Template(rf, ctx) { if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 32);
    i0.ɵɵlistener("click", function LobbyComponent_Conditional_34_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r5); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.startGame()); });
    i0.ɵɵconditionalCreate(1, LobbyComponent_Conditional_34_Conditional_1_Template, 4, 0)(2, LobbyComponent_Conditional_34_Conditional_2_Template, 2, 2, "span");
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = i0.ɵɵnextContext();
...
function LobbyComponent_Conditional_35_Template(rf, ctx) { if (rf & 1) {
...
export class LobbyComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: LobbyComponent, selectors: [["app-lobby"]], decls: 36, vars: 6, consts: [[1, "lobby-shell"], [1, "lobby-header"], [1, "lobby-help"], [1, "lobby-kicker"], ["type", "button", "title", "Copiar c\u00F3digo de sala", 1, "room-code", 3, "click"], [1, "room-code__label"], ["aria-hidden", "true", 1, "room-code__copy"], ["viewBox", "0 0 24 24"], ["x", "8", "y", "8", "width", "11", "height", "11", "rx", "2"], ["d", "M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"], [1, "lobby-subtitle"], ["aria-live", "polite", 1, "lobby-progress"], ["aria-hidden", "true", 1, "lobby-progress__track"], [1, "players-grid"], [1, "player-card", "animate-slide-up", 3, "player-card--ready", "animation-delay"], [1, "player-card", "player-card--empty"], [1, "lobby-actions", "animate-slide-up"], ["type", "button", 1, "btn-primary", "start-button", 3, "disabled"], [1, "host-waiting"], [1, "player-card", "animate-slide-up"], ["size", "lg", 3, "username", "color", "showName", "showCrown", "isActive"], [1, "player-card__body"], [1, "player-card__name"], [1, "host-badge"], [1, "player-status"], ["type", "button", 1, "ready-button", 3, "ready-button--active"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "m3 7 4.5 4L12 4l4.5 7L21 7l-1.5 10h-15L3 7Z"], ["type", "button", 1, "ready-button", 3, "click"], ["d", "M6 6l12 12M18 6 6 18"], ["d", "m5 12.5 4.2 4L19 7"], [1, "empty-avatar"], ["type", "button", 1, "btn-primary", "start-button", 3, "click", "disabled"], ["d", "m9 18 6-6-6-6"], [1, "host-waiting__spinner"]], template: function LobbyComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(29, LobbyComponent_For_30_Template, 11, 15, "article", 14, _forTrack0);
            i0.ɵɵrepeaterCreate(31, LobbyComponent_For_32_Template, 8, 0, "article", 15, i0.ɵɵrepeaterTrackByIndex);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(33, "footer", 16);
            i0.ɵɵconditionalCreate(34, LobbyComponent_Conditional_34_Template, 3, 2, "button", 17)(35, LobbyComponent_Conditional_35_Template, 3, 0, "div", 18);
            i0.ɵɵelementEnd()();
        } if (rf & 2) {
            i0.ɵɵadvance(13);
