...
function LobbyComponent_For_34_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 23);
    i0.ɵɵlistener("click", function LobbyComponent_For_34_Template_button_click_0_listener() { const position_r2 = i0.ɵɵrestoreView(_r1).$implicit; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.setWinningPosition(position_r2)); });
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LobbyComponent_For_37_Conditional_6_Template(rf, ctx) { if (rf & 1) {
...
function LobbyComponent_For_37_Conditional_10_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵnamespaceSVG();
...
function LobbyComponent_For_37_Conditional_10_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelementStart(0, "svg", 32);
...
function LobbyComponent_For_37_Conditional_10_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 34);
    i0.ɵɵlistener("click", function LobbyComponent_For_37_Conditional_10_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r4); const player_r5 = i0.ɵɵnextContext().$implicit; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.setReady(!player_r5.ready)); });
    i0.ɵɵconditionalCreate(1, LobbyComponent_For_37_Conditional_10_Conditional_1_Template, 4, 0)(2, LobbyComponent_For_37_Conditional_10_Conditional_2_Template, 4, 0);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LobbyComponent_For_37_Conditional_11_Template(rf, ctx) { if (rf & 1) {
    const _r6 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 37);
    i0.ɵɵlistener("click", function LobbyComponent_For_37_Conditional_11_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r6); const player_r5 = i0.ɵɵnextContext().$implicit; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.kickPlayer(player_r5)); });
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelementStart(1, "svg", 32);
    ...
    i0.ɵɵtext(4, "Expulsar");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const player_r5 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵattribute("aria-label", "Expulsar a " + player_r5.username);
} }
function LobbyComponent_For_37_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "article", 24);
    i0.ɵɵelement(1, "app-player-avatar", 25);
    i0.ɵɵelementStart(2, "div", 26)(3, "div", 27)(4, "h2");
    i0.ɵɵtext(5);
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(6, LobbyComponent_For_37_Conditional_6_Template, 4, 0, "span", 28);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(7, "div", 29);
    i0.ɵɵelement(8, "span");
    i0.ɵɵtext(9);
    i0.ɵɵelementEnd()();
    i0.ɵɵconditionalCreate(10, LobbyComponent_For_37_Conditional_10_Template, 3, 5, "button", 30);
    i0.ɵɵconditionalCreate(11, LobbyComponent_For_37_Conditional_11_Template, 5, 1, "button", 31);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const player_r5 = ctx.$implicit;
    const ɵ$index_65_r7 = ctx.$index;
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵstyleProp("animation-delay", ɵ$index_65_r7 * 80 + "ms");
    ...
    i0.ɵɵadvance();
    i0.ɵɵconditional(ctx_r2.canManageLobby && player_r5.playerId !== ctx_r2.hostId() ? 11 : -1);
} }
function LobbyComponent_For_39_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "article", 19)(1, "div", 39);
    i0.ɵɵtext(2, "?");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "div", 26)(4, "h2");
...
function LobbyComponent_Conditional_41_Conditional_1_Template(rf, ctx) { if (rf & 1) {
...
function LobbyComponent_Conditional_41_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function LobbyComponent_Conditional_41_Template(rf, ctx) { if (rf & 1) {
    const _r8 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 40);
    i0.ɵɵlistener("click", function LobbyComponent_Conditional_41_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r8); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.startGame()); });
    i0.ɵɵconditionalCreate(1, LobbyComponent_Conditional_41_Conditional_1_Template, 4, 0)(2, LobbyComponent_Conditional_41_Conditional_2_Template, 2, 2, "span");
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = i0.ɵɵnextContext();
...
function LobbyComponent_Conditional_42_Template(rf, ctx) { if (rf & 1) {
...
export class LobbyComponent {
    ...
    personalSubscription = new Subscription();
    emptySlots = computed(() => {
    ...
    async joinRoomFromUrl() {
        ...
        try {
            ...
            this.personalSubscription.add(this.wsService.subscribeToPersonal().subscribe(event => {
    ...
    kickPlayer(player) {
        if (!this.canManageLobby || player.playerId === this.hostId())
            return;
        if (!window.confirm(`¿Expulsar a ${player.username} de la sala?`))
            return;
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: LobbyComponent, selectors: [["app-lobby"]], decls: 43, vars: 7, consts: [[1, "lobby-shell"], [1, "lobby-header"], [1, "lobby-help"], [1, "lobby-kicker"], ["type", "button", "title", "Copiar c\u00F3digo de sala", 1, "room-code", 3, "click"], [1, "room-code__label"], ["aria-hidden", "true", 1, "room-code__copy"], ["viewBox", "0 0 24 24"], ["x", "8", "y", "8", "width", "11", "height", "11", "rx", "2"], ["d", "M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"], [1, "lobby-subtitle"], ["aria-live", "polite", 1, "lobby-progress"], ["aria-hidden", "true", 1, "lobby-progress__track"], ["aria-label", "Meta de la partida", "aria-live", "polite", 1, "round-settings"], [1, "round-settings__eyebrow"], ["role", "group", "aria-label", "Casilla final", 1, "round-settings__choices"], ["type", "button", 3, "is-selected", "disabled"], [1, "players-grid"], [1, "player-card", "animate-slide-up", 3, "player-card--ready", "animation-delay"], [1, "player-card", "player-card--empty"], [1, "lobby-actions", "animate-slide-up"], ["type", "button", 1, "btn-primary", "start-button", 3, "disabled"], [1, "host-waiting"], ["type", "button", 3, "click", "disabled"], [1, "player-card", "animate-slide-up"], ["size", "lg", 3, "username", "color", "showName", "showCrown", "isActive"], [1, "player-card__body"], [1, "player-card__name"], [1, "host-badge"], [1, "player-status"], ["type", "button", 1, "ready-button", 3, "ready-button--active"], ["type", "button", "title", "Expulsar de la sala", 1, "kick-button"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "m3 7 4.5 4L12 4l4.5 7L21 7l-1.5 10h-15L3 7Z"], ["type", "button", 1, "ready-button", 3, "click"], ["d", "M6 6l12 12M18 6 6 18"], ["d", "m5 12.5 4.2 4L19 7"], ["type", "button", "title", "Expulsar de la sala", 1, "kick-button", 3, "click"], ["d", "M10 5H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h5M14 8l4 4-4 4M18 12H9"], [1, "empty-avatar"], ["type", "button", 1, "btn-primary", "start-button", 3, "click", "disabled"], ["d", "m9 18 6-6-6-6"], [1, "host-waiting__spinner"]], template: function LobbyComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(33, LobbyComponent_For_34_Template, 2, 5, "button", 16, i0.ɵɵrepeaterTrackByIdentity);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(35, "div", 17);
            i0.ɵɵrepeaterCreate(36, LobbyComponent_For_37_Template, 12, 16, "article", 18, _forTrack0);
            i0.ɵɵrepeaterCreate(38, LobbyComponent_For_39_Template, 8, 0, "article", 19, i0.ɵɵrepeaterTrackByIndex);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(40, "footer", 20);
            i0.ɵɵconditionalCreate(41, LobbyComponent_Conditional_41_Template, 3, 2, "button", 21)(42, LobbyComponent_Conditional_42_Template, 3, 0, "div", 22);
            i0.ɵɵelementEnd()();
        } if (rf & 2) {
            i0.ɵɵadvance(13);
