...
function CategorySlotsComponent_For_9_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("dragstart", function CategorySlotsComponent_For_9_Template_div_dragstart_0_listener($event) { const ɵ$index_18_r2 = i0.ɵɵrestoreView(_r1).$index; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.startDrag($event, ɵ$index_18_r2)); })("dragover", function CategorySlotsComponent_For_9_Template_div_dragover_0_listener($event) { const ɵ$index_18_r2 = i0.ɵɵrestoreView(_r1).$index; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.allowDrop($event, ɵ$index_18_r2)); })("dragleave", function CategorySlotsComponent_For_9_Template_div_dragleave_0_listener() { const ɵ$index_18_r2 = i0.ɵɵrestoreView(_r1).$index; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.clearDropTarget(ɵ$index_18_r2)); })("drop", function CategorySlotsComponent_For_9_Template_div_drop_0_listener($event) { const ɵ$index_18_r2 = i0.ɵɵrestoreView(_r1).$index; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.drop($event, ɵ$index_18_r2)); })("dragend", function CategorySlotsComponent_For_9_Template_div_dragend_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.endDrag()); })("keydown", function CategorySlotsComponent_For_9_Template_div_keydown_0_listener($event) { const ɵ$index_18_r2 = i0.ɵɵrestoreView(_r1).$index; const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.moveWithKeyboard($event, ɵ$index_18_r2)); });
    ...
    i0.ɵɵclassProp("is-assigning", ctx_r2.isAssigning)("is-dragging", ctx_r2.draggedIndex === ɵ$index_18_r2)("is-drop-target", ctx_r2.dropTargetIndex === ɵ$index_18_r2)("opacity-40", slot_r4.answered)("grayscale", slot_r4.answered);
    i0.ɵɵattribute("draggable", ctx_r2.isAssigning)("tabindex", ctx_r2.isAssigning ? 0 : null)("data-category-index", ɵ$index_18_r2)("aria-label", ctx_r2.isAssigning ? slot_r4.category.name + ", " + slot_r4.pointValue + " puntos. Arrastra o usa las flechas para intercambiar su puntuaci\u00F3n." : null);
    i0.ɵɵadvance();
...
export class CategorySlotsComponent {
    ...
    allowDrop(event, index) {
        if (!this.isAssigning || this.draggedIndex === index)
            return;
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CategorySlotsComponent, selectors: [["app-category-slots"]], inputs: { slots: "slots", isAssigning: "isAssigning", currentSlotIndex: "currentSlotIndex" }, outputs: { assignmentChanged: "assignmentChanged", submitAssignment: "submitAssignment" }, features: [i0.ɵɵNgOnChangesFeature], decls: 12, vars: 3, consts: [[1, "category-panel", "glass", "p-4", "xl:p-5", "rounded-3xl", "animate-slide-up", "h-full", "flex", "flex-col"], [1, "text-xl", "font-black", "mb-4", "flex", "flex-wrap", "gap-2", "items-center", "justify-between", "tracking-wide", "text-white"], [1, "category-heading"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z"], [1, "assignment-chip"], [1, "category-list", "flex", "flex-col", "gap-2.5", "flex-grow", "min-h-0", "overflow-y-auto", "pr-1"], [1, "category-row", "relative", "group", 3, "is-assigning", "is-dragging", "is-drop-target", "opacity-40", "grayscale"], [1, "btn-primary", "w-full", "flex-none", "mt-4", "text-base", "font-black", "py-3", "rounded-2xl", 3, "disabled"], ["role", "status", "aria-live", "polite", 1, "assignment-hint"], [1, "category-row", "relative", "group", 3, "dragstart", "dragover", "dragleave", "drop", "dragend", "keydown"], ["size", "md", 3, "name", "icon", "color", "pointValue", "isHighlighted"], [1, "absolute", "inset-0", "flex", "items-center", "justify-center", "bg-black/45", "rounded-2xl", "z-30", "backdrop-blur-[2px]"], [1, "bg-correct/10", "border", "border-correct/30", "text-correct", "px-4", "py-1.5", "rounded-full", "text-xs", "font-black", "tracking-widest", "uppercase", "flex", "items-center", "gap-2", "shadow-[0_0_15px_rgba(104,244,200,0.1)]"], ["viewBox", "0 0 24 24", "aria-hidden", "true", 1, "resolved-check"], ["d", "m5 12.5 4.2 4L19 7"], [1, "btn-primary", "w-full", "flex-none", "mt-4", "text-base", "font-black", "py-3", "rounded-2xl", 3, "click", "disabled"], ["aria-hidden", "true", 1, "hint-icon"], ["viewBox", "0 0 24 24"], ["d", "M8 11V7a2 2 0 0 1 4 0v3-5a2 2 0 0 1 4 0v5-3a2 2 0 0 1 4 0v7c0 4-3 7-7 7h-1c-3 0-5-1-7-4l-2-3a2 2 0 0 1 3-2l2 2v-3Z"]], template: function CategorySlotsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(8, CategorySlotsComponent_For_9_Template, 3, 20, "div", 7, i0.ɵɵrepeaterTrackByIdentity);
            i0.ɵɵelementEnd();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CategorySlotsComponent, { className: "CategorySlotsComponent", filePath: "src/app/pages/game/components/category-slots/category-slots.component.ts", lineNumber: 21 }); })();
