...
export class CategorySlotsComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CategorySlotsComponent, selectors: [["app-category-slots"]], inputs: { slots: "slots", isAssigning: "isAssigning", currentSlotIndex: "currentSlotIndex" }, outputs: { assignmentChanged: "assignmentChanged", submitAssignment: "submitAssignment" }, features: [i0.ɵɵNgOnChangesFeature], decls: 12, vars: 3, consts: [[1, "category-panel", "glass", "p-4", "xl:p-5", "rounded-3xl", "animate-slide-up", "h-full", "flex", "flex-col"], [1, "text-xl", "font-black", "mb-4", "flex", "flex-wrap", "gap-2", "items-center", "justify-between", "tracking-wide", "text-white"], [1, "category-heading"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z"], [1, "assignment-chip"], [1, "category-list", "flex", "w-full", "min-h-0", "flex-grow", "flex-col", "gap-2.5", "overflow-y-auto", "overflow-x-clip", "pr-1", "max-[40rem]:overflow-y-visible"], [1, "category-row", "relative", "group", 3, "is-assigning", "is-dragging", "is-drop-target", "opacity-40", "grayscale"], [1, "btn-primary", "w-full", "flex-none", "mt-4", "text-base", "font-black", "py-3", "rounded-2xl", 3, "disabled"], ["role", "status", "aria-live", "polite", 1, "assignment-hint"], [1, "category-row", "relative", "group", 3, "dragstart", "dragover", "dragleave", "drop", "dragend", "keydown"], ["size", "md", 3, "name", "icon", "color", "pointValue", "isHighlighted"], [1, "absolute", "inset-0", "flex", "items-center", "justify-center", "bg-black/45", "rounded-2xl", "z-30", "backdrop-blur-[0.125rem]"], [1, "bg-correct/10", "border", "border-correct/30", "text-correct", "px-4", "py-1.5", "rounded-full", "text-xs", "font-black", "tracking-widest", "uppercase", "flex", "items-center", "gap-2", "shadow-[0_0_0.9375rem_rgba(104,244,200,0.1)]"], ["viewBox", "0 0 24 24", "aria-hidden", "true", 1, "resolved-check"], ["d", "m5 12.5 4.2 4L19 7"], [1, "btn-primary", "w-full", "flex-none", "mt-4", "text-base", "font-black", "py-3", "rounded-2xl", 3, "click", "disabled"], ["aria-hidden", "true", 1, "hint-icon"], ["viewBox", "0 0 24 24"], ["d", "M8 11V7a2 2 0 0 1 4 0v3-5a2 2 0 0 1 4 0v5-3a2 2 0 0 1 4 0v7c0 4-3 7-7 7h-1c-3 0-5-1-7-4l-2-3a2 2 0 0 1 3-2l2 2v-3Z"]], template: function CategorySlotsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵrepeaterCreate(8, CategorySlotsComponent_For_9_Template, 3, 20, "div", 7, _forTrack0);
            i0.ɵɵelementEnd();
