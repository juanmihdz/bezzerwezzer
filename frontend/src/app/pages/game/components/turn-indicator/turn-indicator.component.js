...
function TurnIndicatorComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵstyleProp("border-color", ctx_r0.isMyTurn ? "oklch(0.58 0.28 290 / 0.4)" : "rgba(255,255,255,0.08)")("box-shadow", ctx_r0.isMyTurn ? "0 0 25px oklch(0.58 0.28 290 / 0.15)" : "none");
    i0.ɵɵadvance();
    i0.ɵɵstyleProp("background-color", ctx_r0.playerColor)("box-shadow", "0 0 12px " + ctx_r0.playerColor);
    i0.ɵɵadvance(4);
