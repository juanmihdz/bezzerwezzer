...
function BoardComponent_For_16_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction1(9, _c1, ɵ$index_28_r1 === 0 ? "track-cell--start w-8 h-8 md:w-11 md:h-11 z-10 hover:scale-110" : ɵ$index_28_r1 % 5 === 0 ? "track-cell--milestone w-9 h-9 md:w-13 md:h-13 hover:scale-110" : "track-cell--normal w-8 h-8 md:w-11 md:h-11 hover:scale-110"));
    i0.ɵɵadvance();
