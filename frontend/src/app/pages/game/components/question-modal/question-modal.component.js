...
function QuestionModalComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵstyleProp("border-color", ctx_r2.question.categoryColor + "50")("box-shadow", "0 0 50px " + ctx_r2.question.categoryColor + "15");
    i0.ɵɵadvance();
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngClass", ctx_r2.isReboundTurn ? "border-pink-400/60 bg-pink-500/20 text-white shadow-[0_0_18px_rgba(236,72,153,0.25)]" : "border-white/15 bg-white/5 text-white/70");
    i0.ɵɵadvance();
