...
function ResultsComponent_Conditional_12_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 8)(1, "div", 19)(2, "span", 20);
    i0.ɵɵtext(3, "2\u00BA Puesto");
    i0.ɵɵelementEnd();
    i0.ɵɵelement(4, "app-player-avatar", 21);
    i0.ɵɵelementStart(5, "span", 22);
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(7, "div", 23)(8, "span", 24);
    i0.ɵɵtext(9, "\uD83E\uDD48");
    i0.ɵɵelementEnd();
...
function ResultsComponent_Conditional_13_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 9)(1, "div", 26)(2, "span", 27);
    i0.ɵɵtext(3, "Campe\u00F3n");
    i0.ɵɵelementEnd();
    i0.ɵɵelement(4, "app-player-avatar", 28);
...
function ResultsComponent_Conditional_14_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 10)(1, "div", 19)(2, "span", 34);
    ...
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(7, "div", 35)(8, "span", 36);
    i0.ɵɵtext(9, "\uD83E\uDD49");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(10, "span", 25);
    i0.ɵɵtext(11);
...
function ResultsComponent_For_19_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 13)(1, "div", 37);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵelement(3, "app-player-avatar", 38);
    i0.ɵɵelementStart(4, "div", 39)(5, "h4", 40);
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd()();
...
function ResultsComponent_Conditional_21_Template(rf, ctx) { if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 44);
    i0.ɵɵlistener("click", function ResultsComponent_Conditional_21_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r5); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.playAgain()); });
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1(" ", ctx_r1.isHost() ? "Crear revancha" : "Unirme a la revancha", " ");
} }
function ResultsComponent_Conditional_22_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 16);
    i0.ɵɵtext(1, "Esperando a que el anfitri\u00F3n cree la revancha\u2026");
    i0.ɵɵelementEnd();
} }
export class ResultsComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ResultsComponent, selectors: [["app-results"]], decls: 25, vars: 4, consts: [[1, "flex", "flex-1", "flex-col", "items-center", "w-full", "max-w-5xl", "mx-auto", "py-8", "sm:py-12"], [1, "fixed", "inset-0", "pointer-events-none", "z-0", "overflow-hidden"], [1, "absolute", "w-3", "h-3", "rounded-sm", "animate-confetti-fall", 3, "left", "backgroundColor", "animationDelay", "animationDuration"], [1, "text-center", "mb-10", "sm:mb-14", "relative", "z-10", "animate-slide-up", "w-full", "px-4"], [1, "text-6xl", "mb-4", "animate-bounce-in", "drop-shadow-xl", "sm:text-8xl"], [1, "text-4xl", "sm:text-5xl", "md:text-7xl", "font-black", "font-display", "mb-2", "text-transparent", "bg-clip-text", "bg-gradient-to-b", "from-yellow-300", "via-yellow-400", "to-yellow-600", "drop-shadow-lg", "uppercase", "tracking-[0.08em]", "sm:tracking-widest"], [1, "text-xl", "md:text-2xl", "font-bold", "text-gray-300", "mt-2"], [1, "w-full", "max-w-4xl", "mx-auto", "flex", "items-end", "justify-center", "gap-2", "sm:gap-6", "md:gap-10", "mb-14", "sm:mb-20", "relative", "z-10", "px-2", "sm:px-4", "mt-5"], [1, "flex", "flex-col", "items-center", "flex-1", "animate-slide-up", 2, "animation-delay", "200ms"], [1, "flex", "flex-col", "items-center", "flex-1", "animate-slide-up", 2, "animation-delay", "100ms"], [1, "flex", "flex-col", "items-center", "flex-1", "animate-slide-up", 2, "animation-delay", "300ms"], [1, "w-full", "max-w-3xl", "grid", "gap-4", "relative", "z-10", "animate-slide-up", "delay-400", "px-4"], [1, "text-sm", "font-black", "uppercase", "tracking-[0.2em]", "text-text-muted/80", "mb-2", "px-2"], [1, "glass", "p-5", "rounded-2xl", "flex", "items-center", "gap-6", "border", "border-white/5", "transition-all", "duration-300", "hover:scale-[1.01]", 3, "ngClass"], [1, "mt-16", "grid", "gap-3", "relative", "z-10", "w-full", "max-w-sm", "animate-slide-up", "delay-500", "px-4"], [1, "btn-primary", "w-full", "text-xl", "font-black", "py-5", "rounded-2xl"], [1, "text-center", "text-sm", "font-bold", "text-text-muted"], [1, "w-full", "text-lg", "font-black", "py-4", "rounded-2xl", "border", "border-white/15", "text-white/80", "hover:bg-white/5", 3, "click"], [1, "absolute", "w-3", "h-3", "rounded-sm", "animate-confetti-fall"], [1, "relative", "mb-4", "flex", "flex-col", "items-center"], [1, "text-[0.65rem]", "font-black", "text-gray-400", "uppercase", "tracking-widest", "bg-gray-400/10", "border", "border-gray-400/20", "px-3", "py-1", "rounded-full", "mb-3"], ["size", "md", 3, "username", "color", "showName"], [1, "text-lg", "font-bold", "text-white", "mt-3", "truncate", "max-w-[6.25rem]", "sm:max-w-[7.5rem]"], [1, "w-full", "h-28", "sm:h-32", "bg-gray-400/5", "border", "border-gray-400/20", "rounded-t-[1.25rem]", "sm:rounded-t-[2rem]", "flex", "flex-col", "items-center", "justify-center", "p-2", "sm:p-4", "glass-strong", "shadow-lg"], [1, "text-4xl", "font-black", "font-display", "text-gray-400"], [1, "text-[0.65rem]", "font-bold", "text-text-muted/60", "mt-3", "uppercase", "tracking-widest"], [1, "relative", "mb-6", "flex", "flex-col", "items-center", "scale-105", "sm:scale-110"], [1, "text-[0.65rem]", "font-black", "text-yellow-400", "uppercase", "tracking-widest", "bg-yellow-500/10", "border", "border-yellow-500/20", "px-3", "py-1", "rounded-full", "mb-4", "animate-pulse"], ["size", "lg", 3, "username", "color", "showCrown", "showName"], [1, "text-xl", "sm:text-2xl", "font-black", "text-white", "mt-3", "truncate", "max-w-[7.5rem]", "sm:max-w-[8.75rem]"], [1, "w-full", "h-36", "sm:h-44", "bg-yellow-500/10", "border", "border-yellow-500/30", "rounded-t-[1.5rem]", "sm:rounded-t-[2.5rem]", "flex", "flex-col", "items-center", "justify-center", "p-2", "sm:p-4", "glass-strong", "shadow-2xl", "relative", "overflow-hidden"], [1, "absolute", "inset-0", "bg-yellow-500/5", "animate-pulse-glow", "z-0"], [1, "text-5xl", "font-black", "font-display", "text-yellow-400", "relative", "z-10"], [1, "text-[0.65rem]", "font-black", "text-yellow-400", "mt-4", "uppercase", "tracking-wider", "relative", "z-10"], [1, "text-[0.65rem]", "font-black", "text-amber-600", "uppercase", "tracking-widest", "bg-amber-600/10", "border", "border-amber-600/20", "px-3", "py-1", "rounded-full", "mb-3"], [1, "w-full", "h-26", "bg-amber-600/5", "border", "border-amber-600/20", "rounded-t-[2rem]", "flex", "flex-col", "items-center", "justify-center", "p-4", "glass-strong", "shadow-lg"], [1, "text-4xl", "font-black", "font-display", "text-amber-700"], [1, "text-2xl", "font-black", "font-display", "w-12", "text-center", "text-text-muted/50", 3, "ngClass"], ["size", "sm", 3, "username", "color", "showName"], [1, "flex-grow"], [1, "text-lg", "font-extrabold", "text-white", "tracking-wide"], [1, "text-right"], [1, "text-2xl", "font-black", "font-display", "text-white"], [1, "text-[0.65rem]", "font-bold", "uppercase", "tracking-widest", "text-text-muted", "block", "mt-0.5"], [1, "btn-primary", "w-full", "text-xl", "font-black", "py-5", "rounded-2xl", 3, "click"]], template: function ResultsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵconditionalCreate(21, ResultsComponent_Conditional_21_Template, 2, 1, "button", 15)(22, ResultsComponent_Conditional_22_Template, 2, 0, "p", 16);
            i0.ɵɵelementStart(23, "button", 17);
            i0.ɵɵlistener("click", function ResultsComponent_Template_button_click_23_listener() { return ctx.goHome(); });
            i0.ɵɵtext(24, " Volver al Inicio ");
            i0.ɵɵelementEnd()()();
        } if (rf & 2) {
            i0.ɵɵadvance(2);
            ...
            i0.ɵɵadvance(3);
            i0.ɵɵconditional(ctx.isHost() || ctx.canJoinRematch ? 21 : !ctx.isHost() ? 22 : -1);
